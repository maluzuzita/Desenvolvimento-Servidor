...
const pool = mariadb.createPool({
  host: process.env.DBHOST, // local onde esta o banco
  user: process.env.DBUSER, // usuario root do banco
  password: process.env.DBPASS, // senha do root
  database: process.env.DBNAME, // nome do banco a ser criado
  connectionLimit: 5
});
